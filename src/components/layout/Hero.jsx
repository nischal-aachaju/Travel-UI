    ...
    <section className='w-full h-screen px-16 pb-25'>
      <div className="w-full h-full  rounded-3xl flex flex-col justify-center items-center  gap-1" style={{ backgroundImage: `url(${bg})` }}>
        ...
        <div className='flex gap-10'>
          <button className='cursor-pointer px-6 h-12 rounded-3xl shrink-0 bg-white  font-semibold text-gray-800 transition-all text-xl duration-300 ease-out
    hover:-translate-y-1 hover:shadow-xl
    active:translate-y-0 active:shadow-md'>Book now</button>
          <button className='cursor-pointer  px-6 h-12 rounded-3xl shrink-0 border-2 [text-shadow:0_4px_16px_rgba(0,0,0,0.5)] border-white font-semibold text-white text-xl  transition-all duration-300 ease-out
